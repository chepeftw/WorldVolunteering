...
class BasesfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function setup()
  {
    ...
    $this->mergePostValidator(new sfValidatorSchemaCompare('password', sfValidatorSchemaCompare::EQUAL, 'password_again', array(), array('invalid' => 'Las contraseñas no coinciden.')));
  }
}

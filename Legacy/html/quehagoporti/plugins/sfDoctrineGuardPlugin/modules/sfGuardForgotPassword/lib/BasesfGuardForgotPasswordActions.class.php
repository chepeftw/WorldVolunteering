    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        $message = Swift_Message::newInstance()
          ...
          ->setSubject('Solicitud de reposicion de contraseña para '.$this->form->user->username)
        ...
        $this->getUser()->setFlash('notice', 'Porfavor revisa tu correo! Recibiras un mensaje nuestro en poco tiempo!');
        $this->redirect('@sf_guard_signin');
      } else {
        $this->getUser()->setFlash('error', 'Direccion de correo electronico invalida!');
      }
    }
  }
  ...
  public function executeChange($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        $this->getUser()->setFlash('notice', 'Contraseña actualizada exitosamente!');
        $this->redirect('@sf_guard_signin');
      }
    }
  }

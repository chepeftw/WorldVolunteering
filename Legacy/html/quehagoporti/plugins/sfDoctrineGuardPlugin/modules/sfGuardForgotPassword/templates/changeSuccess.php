...
<h3><?php echo __('Ingresa tu nueva contraseña en este formulario.', null, 'sf_guard') ?></h3>
...
<form action="<?php echo url_for('@sf_guard_forgot_password_change?unique_key='.$sf_request->getParameter('unique_key')) ?>" method="POST">
  <table>
    ...
    <tfoot><tr><td><input type="submit" name="Cambiar" value="<?php echo __('Cambiar', null, 'sf_guard') ?>" /></td></tr></tfoot>
  </table>
</form>

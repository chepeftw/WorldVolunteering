...
/**
 * InterestingLink form base class.
 *
 * @method InterestingLink getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseInterestingLinkForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('interesting_link[%s]');

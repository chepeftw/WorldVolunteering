...
class sfValidatorFileImage extends sfValidatorFile
{
  ...
  protected function configure($options = array(), $messages = array())
  {
    ...
    $this->addMessage('invalid_image', '%value% no es un tipo de imagen valida.');
    $this->addMessage('max_height', '"%value%" es mucho alto (%max_height% pixels max).');
    $this->addMessage('min_height', '"%value%" es poco alto (%min_height% pixels min).');
    $this->addMessage('max_width', '"%value%" es mucho ancho (%max_width% pixels max).');
    $this->addMessage('min_width', '"%value%" es poco ancho (%min_width% pixels min).');

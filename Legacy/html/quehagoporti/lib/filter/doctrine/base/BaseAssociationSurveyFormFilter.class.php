...
/**
 * AssociationSurvey filter form base class.
 *
 ...
 */
abstract class BaseAssociationSurveyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('association_survey_filters[%s]');
  ...
  public function addCategoriesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('AssociationSurveyCategory.category_id', $values)
    ;
  }
  ...
  public function addDepartmentsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('AssociationSurveyDepartment.department_id', $values)
    ;
  }

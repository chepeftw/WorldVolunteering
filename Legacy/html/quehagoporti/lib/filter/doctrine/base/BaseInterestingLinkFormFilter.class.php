...
/**
 * InterestingLink filter form base class.
 *
 ...
 */
abstract class BaseInterestingLinkFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('interesting_link_filters[%s]');

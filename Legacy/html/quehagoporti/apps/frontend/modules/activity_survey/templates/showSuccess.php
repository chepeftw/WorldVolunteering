...
<a href="<?php echo url_for('activity_survey/edit?volunteer_survey_id='.$activity_survey->getVolunteerSurveyId().'&association_survey_id='.$activity_survey->getAssociationSurveyId()) ?>">Edit</a>
&nbsp;

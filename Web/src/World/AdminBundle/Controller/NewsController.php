...
use World\AdminBundle\Entity\News;
use World\AdminBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WorldAdminBundle:News')->findAll();

        $entity = new News();

        return $this->render('WorldAdminBundle:News:index.html.twig', array(
            'entities' => $entities,
            'entity' => $entity,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WorldAdminBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WorldAdminBundle:News')->find($id);
        ...
        return $this->render('WorldAdminBundle:News:show.html.twig', array(
            'entity'      => $entity,
